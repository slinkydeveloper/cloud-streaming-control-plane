...
var streamsResource = schema.GroupVersionResource{Group: "streaming.knative.dev", Version: "v1alpha1", Resource: "streams"}

var streamsKind = schema.GroupVersionKind{Group: "streaming.knative.dev", Version: "v1alpha1", Kind: "Stream"}
