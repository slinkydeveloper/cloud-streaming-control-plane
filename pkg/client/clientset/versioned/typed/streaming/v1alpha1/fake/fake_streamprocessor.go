...
var streamprocessorsResource = schema.GroupVersionResource{Group: "streaming.knative.dev", Version: "v1alpha1", Resource: "streamprocessors"}

var streamprocessorsKind = schema.GroupVersionKind{Group: "streaming.knative.dev", Version: "v1alpha1", Kind: "StreamProcessor"}
...
func (c *FakeStreamProcessors) Get(name string, options v1.GetOptions) (result *v1alpha1.StreamProcessor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(streamprocessorsResource, c.ns, name), &v1alpha1.StreamProcessor{})
...
func (c *FakeStreamProcessors) List(opts v1.ListOptions) (result *v1alpha1.StreamProcessorList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(streamprocessorsResource, streamprocessorsKind, c.ns, opts), &v1alpha1.StreamProcessorList{})
...
func (c *FakeStreamProcessors) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(streamprocessorsResource, c.ns, opts))
...
func (c *FakeStreamProcessors) Create(streamProcessor *v1alpha1.StreamProcessor) (result *v1alpha1.StreamProcessor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(streamprocessorsResource, c.ns, streamProcessor), &v1alpha1.StreamProcessor{})
...
func (c *FakeStreamProcessors) Update(streamProcessor *v1alpha1.StreamProcessor) (result *v1alpha1.StreamProcessor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(streamprocessorsResource, c.ns, streamProcessor), &v1alpha1.StreamProcessor{})
...
func (c *FakeStreamProcessors) UpdateStatus(streamProcessor *v1alpha1.StreamProcessor) (*v1alpha1.StreamProcessor, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(streamprocessorsResource, "status", c.ns, streamProcessor), &v1alpha1.StreamProcessor{})
...
func (c *FakeStreamProcessors) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(streamprocessorsResource, c.ns, name), &v1alpha1.StreamProcessor{})
...
func (c *FakeStreamProcessors) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(streamprocessorsResource, c.ns, listOptions)
...
func (c *FakeStreamProcessors) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.StreamProcessor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(streamprocessorsResource, c.ns, name, pt, data, subresources...), &v1alpha1.StreamProcessor{})
