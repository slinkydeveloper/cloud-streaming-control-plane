...
import (
	...
	v1alpha1 "knative.dev/streaming/pkg/client/listers/samples/v1alpha1"
)
...
// NewAddressableServiceInformer constructs a new informer for StreamProcessor type.
...
// NewFilteredAddressableServiceInformer constructs a new informer for StreamProcessor type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredAddressableServiceInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&samplesv1alpha1.StreamProcessor{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *addressableServiceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&samplesv1alpha1.StreamProcessor{}, f.defaultInformer)
}
