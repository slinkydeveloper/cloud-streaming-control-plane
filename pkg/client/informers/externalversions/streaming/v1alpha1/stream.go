	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StreamingV1alpha1().Streams(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StreamingV1alpha1().Streams(namespace).Watch(options)
			},
		},
		&streamingv1alpha1.Stream{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *streamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&streamingv1alpha1.Stream{}, f.defaultInformer)
}
