...
import (
	...
	externalversions "knative.dev/streaming/pkg/client/informers/externalversions"
	client "knative.dev/streaming/pkg/client/injection/client"
)
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch knative.dev/streaming/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
