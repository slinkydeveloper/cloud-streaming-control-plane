...
import (
	...
	addressableservice "knative.dev/streaming/pkg/client/injection/reconciler/samples/v1alpha1/addressableservice"
)
...
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "AddressableServiceReconciled", "StreamProcessor reconciled: \"%s/%s\"", namespace, name)
}
...
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.StreamProcessor) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.StreamProcessor) reconciler.Event {
