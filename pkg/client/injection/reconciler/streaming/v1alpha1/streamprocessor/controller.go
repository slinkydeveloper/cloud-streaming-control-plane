...
const (
	defaultControllerAgentName = "streamprocessor-controller"
	defaultFinalizerName       = "streamprocessors.streaming.knative.dev"
	defaultQueueName           = "streamprocessors"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	rec := &reconcilerImpl{
		...
		Lister:     streamprocessorInformer.Lister(),
		Recorder:   recorder,
		reconciler: r,
	}
