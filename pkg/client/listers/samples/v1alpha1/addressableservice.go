...
// List lists all AddressableServices in the indexer.
func (s *addressableServiceLister) List(selector labels.Selector) (ret []*v1alpha1.StreamProcessor, err error) {
...
// List lists all AddressableServices in the indexer for a given namespace.
func (s addressableServiceNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.StreamProcessor, err error) {
...
// Get retrieves the StreamProcessor from the indexer for a given namespace and name.
func (s addressableServiceNamespaceLister) Get(name string) (*v1alpha1.StreamProcessor, error) {
