...
import (
	...
	samplesv1alpha1 "knative.dev/streaming/pkg/apis/streaming/v1alpha1"
	addressableservicereconciler "knative.dev/streaming/pkg/client/injection/reconciler/samples/v1alpha1/addressableservice"
)

// newReconciledNormal makes a new reconciler event with event type Normal, and
// reason AddressableServiceReconciled.
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(corev1.EventTypeNormal, "AddressableServiceReconciled", "StreamProcessor reconciled: \"%s/%s\"", namespace, name)
}

// Reconciler implements addressableservicereconciler.Interface for
// StreamProcessor resources.
...
func (r *Reconciler) ReconcileKind(ctx context.Context, o *samplesv1alpha1.StreamProcessor) reconciler.Event {
...
func (r *Reconciler) reconcileForService(ctx context.Context, asvc *samplesv1alpha1.StreamProcessor) error {
