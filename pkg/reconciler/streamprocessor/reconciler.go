...
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "StreamProcessorReconciled", "StreamProcessor reconciled: \"%s/%s\"", namespace, name)
}
...
//var _ streamprocessor.Finalizer = (*Reconciler)(nil)
